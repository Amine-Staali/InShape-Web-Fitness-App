...
class ProcessFrame:
    ...
    def process(self, frame: np.array, pose):
        ...
        if self.reps == self.state_tracker['SQUAT_COUNT']:
            display_duration = 60  
...
#
        ...
        if(self.rest_timer > 0):
            ...
            #print(f"Rest Time:{int(min)}:{int(sec)}")
                ...
                # Display completion message and motivational message
                # Increase the delay here to display the messages for a longer duration
