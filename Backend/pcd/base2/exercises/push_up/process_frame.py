...
class ProcessFrame:
    ...
    def process(self, frame: np.array, pose):
        ...
        if keypoints.pose_landmarks:
            ...
            # Camera is aligned properly.
                ...
                # -------------------------------------- PERFORM FEEDBACK ACTIONS --------------------------------------
                   ...
                   #go deeper:s2-->s3    shoulder_elbow_vert in[40,80]
                    ...
                    #elbows_pointed_out: shoulder_elbow_vert<10 and knee_ankle_vert>60
                    if elbow_vertical_angle < self.thresholds['ELBOW_THRESH'] and self.state_tracker['state_seq'].count('s2')==1 :
            ...
            self.state_tracker['start_inactive_time_front'] = time.perf_counter()
        if self.reps == self.state_tracker['PUSHUP_COUNT']:
            display_duration = 60  
