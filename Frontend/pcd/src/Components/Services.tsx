...
import miniTick from "../assets/mini-tick.png";
  ...
  useEffect(() => {
    const handleScroll = () => {
      if (servicesRef.current) {
        const sectionPosition = servicesRef.current.getBoundingClientRect().top;
  ...
  return (
    <>
      <div className="title-services">
        <span className="services-text-deco">Ready to start </span>
        <span>your journey </span>
        <span className="services-text-deco">now with us</span>
      </div>
      <div className="Plans" ref={servicesRef}>
        {/*Free Trial*/}
        <div
          className={`Basic-plan ${
            serviceVisible ? "BasicLeftVisible" : "BasicLeftNotVisible"
          }`}
        >
          <div className="svg">
            <svg
          ...
          <span className="title-plan">Free Trial</span>
          <span className="price">$0</span>
          <ul className="advantages">
            <li className="advantage">
              <img src={miniTick} loading="lazy" alt="miniTick" />
              <span className="advantageItem">1 Free program</span>
            </li>
            <li className="advantage">
              <img src={miniTick} loading="lazy" alt="miniTick" />
              <span className="advantageItem">Test our IA coach</span>
            </li>
            <li className="advantage">
              <img src={miniTick} loading="lazy" alt="miniTick" />
              <span className="advantageItem">Nutrition advices</span>
            </li>
          </ul>
          {user ? (
            <Link className="Links" to={"/Profile/"}>
              <button className="Basic-button">Already Subscribed</button>
            </Link>
          ) : (
        ...
        <div
          className={`Premium-plan ${
            serviceVisible ? "PremiumVisible" : "PremiumNotVisible"
          }`}
        >
          <div className="svg">
            <svg
          ...
          <span className="title-plan">Premium plan</span>
          <span className="price">$ 30</span>
          <ul className="advantages">
            <li className="advantage">
              <img src={miniTick} loading="lazy" alt="miniTick" />
              <span className="advantageItem">
                Unlimited Customized workout programs
              </span>
            </li>
            <li className="advantage">
              <img src={miniTick} loading="lazy" alt="miniTick" />
              <span className="advantageItem">Get trained by our IA coach</span>
            </li>
            <li className="advantage">
              <img src={miniTick} loading="lazy" alt="miniTick" />
              <span className="advantageItem">
                Nutrition routine and health check
              </span>
            </li>
          </ul>
          <button className="Premium-button Basic-button">Join now</button>
        </div>
        {/* Pro Plan */}
        <div
          className={`Basic-plan ${
            serviceVisible ? "BasicRightVisible" : "BasicRightNotVisible"
          }`}
        >
          <div className="svg">
            <svg
          ...
          <span className="title-plan">Pro plan</span>
          <span className="price">$ 15</span>
          <ul className="advantages">
            <li className="advantage">
              <img src={miniTick} loading="lazy" alt="miniTick" />
              <span className="advantageItem">
                10 Customized workout programs
              </span>
            </li>
            <li className="advantage">
              <img src={miniTick} loading="lazy" alt="miniTick" />
              <span className="advantageItem">access to our IA coach</span>
            </li>
            <li className="advantage">
              <img src={miniTick} loading="lazy" alt="miniTick" />
              <span className="advantageItem">
                Nutrition advices and health check
              </span>
            </li>
          </ul>
          <button className="Basic-button">Join now</button>
